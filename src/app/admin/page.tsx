...
export default function AdminDashboard() {
  return (
    <div className="space-y-6">
      ...
      <p className="text-sm text-gray-600 mb-6">관리자 대시보드에 오신 것을 환영합니다.</p>

      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-lg border bg-white p-6 shadow-sm hover:shadow-md transition-shadow border-l-4 border-l-gray-900">
